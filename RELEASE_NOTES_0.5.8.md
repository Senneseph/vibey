...
### 2. **OpenSpec and MCP Integration** 🔗
...
### 6. **Build Artifacts Management** 🗑️
...
6. **Build Artifacts Management**: Improved build process
7. **Documentation Updates**: Fixed links and updated README.md
...
**v0.5.8** - December 2025
**Vibey: Chat with your code**

*"Now you can integrate with OpenAI-compatible endpoints, enjoy enhanced project analysis, and benefit from improved build management!"